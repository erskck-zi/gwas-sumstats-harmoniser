...
```
remote_vcf_location = 'https://ftp.ensembl.org/pub/current_variation/vcf/homo_sapiens'
remote_ensembl_variation = 'https://ftp.ensembl.org/pub/release-100/mysql/homo_sapiens_variation_100_38'
```
